...
\newcommand{\vedouci}{Ing. Ondřej Klempíř, Ph.D.}
\newcommand{\nazev}{Data Catalog: A Web Application for Visualization and Analysis of Longitudinal Administrative Data }
\newcommand{\nazevENG}{Data Catalog: Webová aplikace pro zobrazení a analýzu longitudinálních administrativních dat }
\newcommand{\typ}{Master's thesis}
\newcommand{\rok}{2026}
...
\newcommand{\program}{Biomedicínská a klinická informatika}
\newcommand{\obor}{Softwarové technologie}       % u nových akreditací vypustit
...
\begin{document}
	...
	\begin{titlepage}
 		...
 		\end{figure}
 		\textsf{\large{\textbf{CZECH TECHNICAL UNIVERSITY IN PRAGUE}}}\\
 		%\vspace{0pt}   		
		...
		\textsf{\textbf{Department of Biomedical Informatics}}\\	
	...
	\null\vfill
	\section*{Poděkování}
Ráda bych poděkovala vedoucímu své diplomové práce, Ing. Ondřeji Klempířovi, Ph.D., za jeho čas, trpělivost a dlouhodobou podporu. Oceňuji možnost se kdykoli na cokoli zeptat – i na velmi konkrétní věci – a dostávat podrobné a vstřícné odpovědi, nejčastěji přes Teams.

Děkuji také za to, že mi umožnil zpracovávat téma způsobem, který mi vyhovoval, a za množství cenných rad a nápadů, například při řešení HMM, kde jste mi opakovaně pomáhal se zorientovat.

A v neposlední řadě děkuji za pochopení pro můj styl práce, kdy se dlouho neozvu a pak pošlu sérii dotazů najednou. Vaše trpělivost mi moc pomohla.
	...
	\input{00_seznam_symbolu_a_zkratek}
	\clearpage
	...
	\input{02_prehled_soucasneho_stavu}
	\clearpage
...
%-------------Literatura-------------------
    ...
    \addcontentsline{toc}{section}{Reference}     % Přidání této kapitoly do obsahu
    \printbibliography
    \clearpage
